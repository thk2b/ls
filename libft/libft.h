...
/*   Updated: 2018/09/18 14:14:25 by tkobb            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
** void ft_btree_new(t_btree **rootp, void *data);
** void ft_btree_add(
** 		t_btree **rootp, void *data, int (*f)(void *ref, void*, void*));
** void ft_btree_delone(t_btree **tree, void (*del)(void *ref, void*));
** void ft_btree_del(t_btree **tree, void (*del)(void *ref, void*));
** void	ft_btree_find(t_btree *tree, void (*cmp)(void *ref, void*, void*));
** void	ft_btree_preorder(t_btree *tree, void (*cmp)(void *ref, void*, void*));
** void	ft_btree_inorder(t_btree *tree, void (*cmp)(void*, void*));
** void	ft_btree_postorder(t_btree *tree, void (*cmp)(void*, void*));
** void	ft_btree_backpreorder(t_btree *tree, void (*cmp)(void*, void*));
** void	ft_btree_backinorder(t_btree *tree, void (*cmp)(void*, void*));
** void	ft_btree_backpostorder(t_btree *tree, void (*cmp)(void*, void*));
*/
